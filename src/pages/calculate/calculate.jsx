    ...
    return (
        <div id="cal_outer">
            <div id='calculate-container'>
                <div id="cal-content1">
                    <User_input
                        setStart_age={setStart_age}
                        setworking_years={setworking_years}
                        setinitial_salary_before_tax={setinitial_salary_before_tax}
                        setstartneeded_amount_age={setstartneeded_amount_age}
                        start_age={start_age}
                        working_years={working_years}
                        initial_salary_before_tax={initial_salary_before_tax}
                        startneeded_amount_age={startneeded_amount_age}
                    />
                </div>
                <div id="cal-content2">
                    <User_output
